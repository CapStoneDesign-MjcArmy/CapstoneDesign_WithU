...
import '../family/print_info.dart';
import '../family/print_num_select_pub.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image:
                AssetImage("assets/images/backgroundImg.png"), // 배경 이미지를 추가하세요
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CertificateIssuanceForm(
                              idNumber: idNumber, include: true)),
                    );
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => CertificateIssuanceForm(
                              idNumber: idNumber, include: false)),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(vertical: 20, horizontal: 20),
...
class CertificateIssuanceForm extends StatefulWidget {
  ...
  CertificateIssuanceForm(
      {required this.idNumber, required this.include}); // 생성자 추가
